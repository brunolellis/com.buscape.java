...
public class BuscapeWeb extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().print("--- modelo antigo");
		exibirOfertas(510109, "Samsung Lava e seca Seine WD106UHSAWQ Frontal 10,1 Kg Branco", resp);
		exibirOfertas(510538, "Samsung Lava e seca Seine WD106UHSAGD Frontal 10,1 Kg Inox Look", resp);
		
		resp.getWriter().print("--- modelo novo");
		...
		exibirOfertas(618930, "Samsung Lava e seca WD6000 WD10J6410AX Frontal 10,2 Kg Inox Look", resp);
